...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --arch=armv7a --cpu=armv7-a --disable-armv6 --disable-armv6t2 --enable-thumb --enable-neon --enable-vfpv3 --target-os=arm-linux --disable-stripping --prefix=../output --enable-version3 --enable-shared --disable-static --enable-gpl --sysroot=../../prebuilts/ndk/current/platforms/android-17/arch-arm --cross-prefix=../../android/system/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi- --enable-avcodec --enable-avutil --enable-avresample --enable-postproc --disable-ffmpeg --disable-avdevice --disable-outdevs --disable-ffplay --disable-ffprobe --disable-ffserver --disable-network --disable-symver --disable-doc --enable-filter=scale --libdir=/system/lib --enable-zlib --extra-libs=-lgcc --extra-cflags='-DANDROID -D__thumb__ -mthumb -mandroid -Wfatal-errors -Wno-deprecated -fno-math-errno -fno-signed-zeros'
prefix=../output
...
CC_IDENT=gcc 4.7.4 (Linaro GCC 4.7-2013.09-1~dev) 20130903 (prerelease)
ARCH=arm
CC=../../android/system/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-gcc
CXX=../../android/system/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-g++
AS=../../android/system/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-gcc
DEPCC=../../android/system/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=../../android/system/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=../../android/system/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=../../android/system/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-ranlib
STRIP=echo skipping strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=../../prebuilts/ndk/current/platforms/android-17/arch-arm
CFLAGS=  -DANDROID -D__thumb__ -mthumb -mandroid -Wfatal-errors -Wno-deprecated -fno-math-errno -fno-signed-zeros -march=armv7-a -fomit-frame-pointer -mthumb -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -D_ISOC99_SOURCE
ASFLAGS=  -DANDROID -D__thumb__ -mthumb -mandroid -Wfatal-errors -Wno-deprecated -fno-math-errno -fno-signed-zeros -march=armv7-a -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
